                        ...
                        <table id="example" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">MONTANT REMBOUSER </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($locations as $location)
                                    <tr>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a href="{{ url('DTFin_contrat=' . $location->id) }}"
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            {{ $location->maison }}/{{ $location->type_logement_nom }}
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">{{ $location->date_debut }}
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            {{ $location->date_fin }} </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            {{ $location->ville_nom }} dans le Quatier {{ $location->quartier_nom }} </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            {{ $location->Mt_rembouser }}
