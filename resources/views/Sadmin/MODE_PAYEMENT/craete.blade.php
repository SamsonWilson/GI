                    ...
                    <div class="card border-top border-0 border-4 border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-white"> MODE DE PAYEMENT </h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="{{ route('enregistremodepayement') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                    <label for="inputLastName" class="form-label">Nom du Mode de payement </label>
