...
@section('contenu')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div><a name="" id="" class="btn btn-primary" href="{{ route('ajouter_Mode_Payement') }}"
                    role="button">AJOUTER MODE DE PAYEMENT </a> </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="example2" class="table table-striped table-bordered dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th style="text-align: center; vertical-align: middle;">Nom
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach ($MdPayements as $MdPayement)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle;">
                                                        <div class="d-flex order-actions"
                                                            ...
                                                            <a href="{{ url('quartier=' . $MdPayement->id) }}"
                                                                class=""><i class='bx bxs-edit'></i></a>
                                                            <form
                                                                action="{{ route('delete_quartier', ['quartier' => $MdPayement->id]) }}"
                                                                method="POST">
                                                                @method('DELETE')
                                                                @csrf
