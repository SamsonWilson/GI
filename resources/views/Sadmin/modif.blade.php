						...
						<div class="card border-top border-0 border-4 border-white">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									<h5 class="mb-0 text-white">Modifier une ville</h5>
								</div>
								<hr>
								<form class="row g-3" method="POST" action="{{ url('update_ville/'. $villes->id) }}",enctype="multipart/form-data">
									...
									<div class="col-md-12">
										...
										<input type="text" class="form-control" value="{{ $villes->nom }}" name="nom" id="inputLastName" placeholder="Nom de la ville">
									</div>
									<div class="col-12">
										<label for="inputAddress" class="form-label">Description de la ville</label>
										<textarea class="form-control"  value="{{ $villes->description }}" name="description" id="inputAddress" placeholder="Description de la ville" rows="3"></textarea>
									</div>
                                    {{--  <div class="col-12">
