                        ...
                        <div class="card-body p-5">
                            ...
                            @foreach ($proprietaires as $proprietaire)
                                <form class="row g-3" method="POST"
                                    action="{{ url('update_Proprietaire/' . $proprietaire->id) }}",enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label class="file-input-wrapper">
                                            ...
                                            <input id="fancy-file-upload" type="file"
                                                value="/storage/imageProprietaire/{{ $proprietaire->photo }}"
                                                name="imageProprietaire" onchange="previewImage(event)">
                                        </label>
                                        <hr>
                                    ...
                                    <div class="col-md-6">
                                        <label for="inputFirstName" class="form-label"> Nom </label>
                                        <input type="text" value="{{ $proprietaire->nom }}" class="form-control"
                                            id="inputFirstName" name="nom">
                                        @error('nom')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="{{ $proprietaire->prenom }}" class="form-control"
                                            id="inputLastName" name="prenom">
                                        @error('prenom')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" value="{{ $proprietaire->tel1 }}" class="form-control"
                                            id="inputEmail" name="tel1">
                                        @error('tel1')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" value="{{ $proprietaire->tel2 }}" class="form-control"
                                            id="inputPassword" name="tel2">
                                        @error('tel2')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" value="{{ $proprietaire->email }}" class="form-control"
                                            id="inputPassword" name="email">
                                        @error('email')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select id="inputState" class="form-select" value="{{ $proprietaire->sex }}"
                                            name="sex">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" value="{{ $proprietaire->adress }}" id="inputAddress" placeholder="Address..."
                                            rows="3" name="adress"></textarea>
                                        @error('adress')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
